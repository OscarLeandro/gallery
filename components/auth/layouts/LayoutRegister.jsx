...
import { postUser } from "../../../hooks/useFetchUser";
...
//       //console.log('la imnagen cortada creo yo',croppedImage);  
//       setCroppedImagen(croppedImage);
//     }
    
    
//     // Aquí puedes enviar la imagen recortada al backend
//   };
  
//   useEffect(() => {
//   console.log('eldata',croppedImagen);

  
// }, [croppedImagen])

  const mutationPost = useMutation(body => postUser(`${BASE_URL}/api/user`, body),{
    onSuccess: data => {
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6">
              ...
              {cropperReady && croppedImagen && <button type="submit">Cargar</button>} */}
